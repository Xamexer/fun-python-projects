...
# Scale points to a desired size
...
# Recognize a gesture by matching against a set of templates
...
# Calculate the distance between two paths at a given angle
